...
parser.add_argument('--exp_name', default='cifar10/FFL_res32', type=str)
parser.add_argument('--log_time', default='1', type=str)
parser.add_argument('--lr', default='0.12', type=float)
...
trainloader, valloader, testloader = utils.get_cifar10_dataloaders(128, 100)
num_classes = 10
